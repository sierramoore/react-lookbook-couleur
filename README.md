...
The user is able to paste url's from other websites into a field and all the images will be extracted form that website and saved into
the users profile page. On the users profile page they are able to remove thier saved images as desired.</p>
